...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { image: @destination.image, name: @destination.name, post: @destination.post, title: @destination.title }
    end
  ...
  test "should update destination" do
    patch :update, id: @destination, destination: { image: @destination.image, name: @destination.name, post: @destination.post, title: @destination.title }
    assert_redirected_to destination_path(assigns(:destination))
  end
